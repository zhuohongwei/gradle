...
public class DaemonParameters {
    ...
    public static final List<String> DEFAULT_JVM_ARGS = ImmutableList.of("-Xms256m", "-Xmx512m", "-XX:MaxPermSize=256m", "-XX:+HeapDumpOnOutOfMemoryError");
    public static final List<String> DEFAULT_JVM_8_ARGS = ImmutableList.of("-Xms256m", "-Xmx512m", "-XX:MaxMetaspaceSize=256m", "-XX:+HeapDumpOnOutOfMemoryError", "-XX:+UseG1GC");

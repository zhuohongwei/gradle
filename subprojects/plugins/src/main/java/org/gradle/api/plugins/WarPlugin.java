...
public class WarPlugin implements Plugin<Project> {
    ...
    public void apply(final Project project) {
        ...
        TaskProvider<War> war = project.getTasks().register(WAR_TASK_NAME, War.class, war1 -> {
            war1.setDescription("Generates a war archive with all the compiled classes, the web-app content and the libraries.");
            war1.setGroup(BasePlugin.BUILD_GROUP);
        });

...
class JUnitTestClassProcessorTest extends Specification {
    ...
    def spec = new JUnitSpec([] as Set, [] as Set, [] as Set, [] as Set, [] as Set, 0)
    ...
    def "executes specific method"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, [ATestClassWithSeveralMethods.name + ".pass"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes multiple specific methods"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, [ATestClassWithSeveralMethods.name + ".pass",
                                                                       ATestClassWithSeveralMethods.name + ".pass2"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes methods from multiple classes by pattern"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*Methods.*Slowly*"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes all tests for class with test runner that is not filterable when any test description matches"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, [ATestClassWithRunner.name + ".ok"] as Set, [] as Set, [] as Set, 0))
    ...
    def "does not execute class with test runner that is not filterable when no test description matches"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, [ATestClassWithRunner.name + ".ignoreme"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes no methods when method name does not match"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["does not exist"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes all tests within a JUnit 3 suite when the suite class name matches"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*ATestClassWithSuiteMethod"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes all tests within a suite when the suite class name matches"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*ATestSuite"] as Set, [] as Set, [] as Set, 0))
    ...
    def "executes all tests within a custom runner suite class name matches"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*ACustomSuite"] as Set, [] as Set, [] as Set, 0))
    ...
    def "attempting to filter methods on a suite does NOT work"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*ATestSuite.ok*"] as Set, [] as Set, [] as Set, 0))
    ...
    def "has no errors when dealing with an empty suite"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AnEmptyTestSuite"] as Set, [] as Set, [] as Set, 0))
    ...
    def "parameterized tests can be run with a class-level filter"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AParameterizedTest"] as Set, [] as Set, [] as Set, 0))
    ...
    def "parameterized tests can be filtered by method name"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AParameterizedTest.helpfulTest*"] as Set, [] as Set, [] as Set, 0))
    ...
    def "parameterized tests can be filtered by iteration only."() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AParameterizedTest.*[1]"] as Set, [] as Set, [] as Set, 0))
    ...
    def "parameterized tests can be filtered by full method name"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AParameterizedTest.helpfulTest[1]"] as Set, [] as Set, [] as Set, 0))
    ...
    def "parameterized tests can be empty"() {
        classProcessor = withSpec(new JUnitSpec([] as Set, [] as Set, ["*AnEmptyParameterizedTest"] as Set, [] as Set, [] as Set, 0))

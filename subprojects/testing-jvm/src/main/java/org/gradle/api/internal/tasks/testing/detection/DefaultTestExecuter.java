...
import org.gradle.api.internal.tasks.testing.processors.RerunFailedTestExecuter;
...
public class DefaultTestExecuter implements TestExecuter<JvmTestExecutionSpec> {
    ...
    public void execute(final JvmTestExecutionSpec testExecutionSpec,
        ...
        TestClassProcessor delegate = new RerunFailedTestExecuter(
            numberOfRetries,
        ...
        processor =
            new PatternMatchTestClassProcessor(testFilter,
                new RunPreviousFailedFirstTestClassProcessor(testExecutionSpec.getPreviousFailedTestClasses(), delegate));

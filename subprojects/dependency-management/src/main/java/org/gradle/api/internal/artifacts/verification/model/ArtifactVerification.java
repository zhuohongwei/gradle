...
public class ArtifactVerification {
    private final ComponentArtifactIdentifier artifact;
    private final Map<ChecksumKind, String> checksums;

    public ArtifactVerification(ComponentArtifactIdentifier artifact, Map<ChecksumKind, String> checksums) {
        this.artifact = artifact;
        this.checksums = ImmutableMap.copyOf(checksums);
    }

    public ComponentArtifactIdentifier getArtifact() {
        return artifact;
    }

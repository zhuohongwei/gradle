...
public class DefaultGradleLauncherFactory implements GradleLauncherFactory {
    ...
    public GradleLauncher newInstance(BuildDefinition buildDefinition, RootBuildState build, BuildTreeScopeServices parentRegistry) {
        ...
        DefaultGradleLauncher launcher = doNewInstance(buildDefinition, build, null, parentRegistry, ImmutableList.of((Stoppable) () -> rootBuild = null));
        rootBuild = launcher;
    ...
    private class NestedBuildFactoryImpl implements NestedBuildFactory {
        ...
        public GradleLauncher nestedBuildTree(BuildDefinition buildDefinition, NestedRootBuild build) {
            ...
            return doNewInstance(buildDefinition, build, parent, buildTreeScopeServices, ImmutableList.of(buildTreeScopeServices, sessionScopeServices, (Stoppable) () -> userHomeDirServiceRegistry.release(userHomeServices)));
        }
